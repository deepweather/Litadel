...
def get_earnings_estimates(ticker: str) -> str:
    ...
    try:
        ...
        error_msg = f"Error retrieving earnings estimates for {ticker}: {str(e)}"
        return error_msg
...
def get_top_gainers() -> str:
    ...
    try:
        ...
        return f"Error retrieving top gainers: {str(e)}"
...
def get_top_losers() -> str:
    ...
    try:
        ...
        return f"Error retrieving top losers: {str(e)}"
...
def get_earnings_call_transcript(ticker: str, quarter: Optional[str] = None) -> str:
    """
