...
def extract_trading_decision(reports: list[AnalysisReport]) -> TradingDecision | None:
    ...
    return TradingDecision(decision=decision, confidence=confidence, rationale=rationale)
